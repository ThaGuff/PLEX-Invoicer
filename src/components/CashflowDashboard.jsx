...
export default function CashflowDashboard({ accountId, accent = '#13B5EA' }) {
                ...
                <div className="space-y-1">
                  {client_profiles.map((p, i) => (
                    <div key={i} className="flex items-center gap-3 text-xs py-1">
                      ...
                      <span className="font-semibold" style={{ color: p.avg_dtp <= 7 ? '#22c55e' : p.avg_dtp <= 30 ? accent : '#ef4444' }}>
